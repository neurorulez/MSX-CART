@echo off
rem --- 'zz2_prepare_multi_release.cmd' v2.4 by KdL (2019.04.15)
...
echo rem --- 'compile_multi_release.cmd' v2.4 by KdL (2019.04.15)>>%DEST%compile_multi_release.cmd
...
set INPDIR=%SRC%
set OUTDIR=%DEST%esemsx3_%LAYOUT%_msx2plus\
echo cd "%OUTDIR%">>%DEST%compile_multi_release.cmd
...
:quit
echo exit>>%DEST%compile_multi_release.cmd
